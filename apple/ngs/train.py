...
def evaluate(model, dataloader, opt):
    ...
    for sample in dataloader:
        ...
        temp_dict["Selected_probs"] = selected_probs.tolist()
        ...
        if opt.model_mode =='eval':
            ...
            temp_dict["expr_preds"] = expr_preds[0]
            temp_dict["actual_expr"] = expr[0]
            temp_dict["res_preds"] = res_preds[0]
